...
public class fr_bquiz_ques18 extends Fragment {
    ...
    private String quesid = "Question18";
    private String quesno = "17";
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_bquiz_ques18,container,false);
            ...
            public void onClick(View v) {
                ...
                if (option != -1 || checkBox.isChecked()){
                    ...
                    if (checkBox.isChecked()){
                        ...
                        //.makeText( getActivity().getApplicationContext(),"Skipped",Toast.LENGTH_SHORT ).show();

                        final FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
                        fragmentTransaction.replace(R.id.container_bquiz,new fr_bquiz_ques19());
        ...
        previous_ques.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
               //Toast.makeText( getActivity(),"prev ques" ,Toast.LENGTH_SHORT).show();
                final FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.container_bquiz,new fr_bquiz_ques17());
                fragmentTransaction.commit();
