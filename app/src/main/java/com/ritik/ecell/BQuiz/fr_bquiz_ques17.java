...
public class fr_bquiz_ques17 extends Fragment {
    ...
    private String quesid = "Question17";
    private String quesno = "16";
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_bquiz_ques17,container,false);
