...
public class fr_bquiz_ques9 extends Fragment {
    ...
    private String quesid = "Question9";
    private String quesno = "8";
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_bquiz_ques9,container,false);
        ...
        previous_ques.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.container_bquiz,new fr_bquiz_ques8());
                fragmentTransaction.commit();
