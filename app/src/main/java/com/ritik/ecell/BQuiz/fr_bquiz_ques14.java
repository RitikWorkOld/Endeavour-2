...
public class fr_bquiz_ques14 extends Fragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_bquiz_ques14,container,false);
                ...
                if (option != -1 || checkBox.isChecked()){
                    ...
                    if (checkBox.isChecked()){
                        ...
                        if (str.equals( correctanswer )){
                            ...
                            Report report = new Report( "wrong" ,str,1);
