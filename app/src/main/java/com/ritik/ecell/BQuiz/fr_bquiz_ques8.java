...
public class fr_bquiz_ques8 extends Fragment {
    ...
    private String quesid = "Question8";
    private String quesno = "7";
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_bquiz_ques8,container,false);
            ...
            public void onClick(View v) {
                ...
                if (option != -1 || checkBox.isChecked()){
                    ...
                    if (checkBox.isChecked()){
                        ...
                        fragmentTransaction.replace(R.id.container_bquiz,new fr_bquiz_ques9());
