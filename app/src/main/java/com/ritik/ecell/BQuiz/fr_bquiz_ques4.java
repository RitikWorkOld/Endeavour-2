...
public class fr_bquiz_ques4 extends Fragment {
    ...
    private String quesid = "Question4" ;
    private String quesno = "3" ;
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_bquiz_ques4,container,false);
            ...
            public void onClick(View v) {
                ...
                if (option != -1 || checkBox.isChecked()){
                    ...
                    if (checkBox.isChecked()){
                        ...
                        fragmentTransaction.replace(R.id.container_bquiz,new fr_bquiz_ques5());
        ...
        previous_ques.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.container_bquiz,new fr_bquiz_ques3());
                fragmentTransaction.commit();
