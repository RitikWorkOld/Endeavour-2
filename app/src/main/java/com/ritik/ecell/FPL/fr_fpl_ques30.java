...
import com.ritik.ecell.BQuiz.fr_bquiz_ques19;
import com.ritik.ecell.R;

public class fr_fpl_ques30 extends Fragment {
    ...
    private String quesid = "Question30";
    private String quesno = "29";
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_fpl_ques30,container,false);
