...
public class fr_fpl_ques25 extends Fragment {
    ...
    private String quesid = "Question25";
    private String quesno = "24";
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_fpl_ques25,container,false);
