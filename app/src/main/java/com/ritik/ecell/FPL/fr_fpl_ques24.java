...
public class fr_fpl_ques24 extends Fragment {
    ...
    private String quesid = "Question24";
    private String quesno = "23";
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_fpl_ques24,container,false);
