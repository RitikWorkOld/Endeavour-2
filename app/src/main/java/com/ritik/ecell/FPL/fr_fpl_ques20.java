...
public class fr_fpl_ques20 extends Fragment {
    ...
    private String quesid = "Question20";
    private String quesno = "19";
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_fpl_ques20,container,false);
            ...
            public void onClick(View v) {
                ...
                if (option != -1 || checkBox.isChecked()){
                    ...
                    if (checkBox.isChecked()){
                        ...
                        fragmentTransaction.replace(R.id.container_fpl,new fr_fpl_ques21());
