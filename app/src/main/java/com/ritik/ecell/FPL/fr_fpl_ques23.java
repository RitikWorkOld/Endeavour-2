...
public class fr_fpl_ques23 extends Fragment {
    ...
    private String quesid = "Question23";
    private String quesno = "22";
    private CheckBox checkBox;

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate( R.layout.fr_fpl_ques23,container,false);
            ...
            public void onClick(View v) {
                ...
                if (option != -1 || checkBox.isChecked()){
                    ...
                    if (checkBox.isChecked()){
                        ...
                        fragmentTransaction.replace(R.id.container_fpl,new fr_fpl_ques24());
